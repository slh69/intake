...
//https://github.com/probil/v-mask/issues/498
...
createApp(App)
  ...
  button: {
    wrapper: 'mb-1',
    input: 'bg-cyan-400 hover:bg-purple-500 text-white text-sm font-normal py-3 px-5 rounded'
  },
  color: {
  ...
  text: {  
    label: 'block mb-1 font-bold text-sm overflow-hidden formkit-invalid:text-red-500',
    inner: 'overflow-hidden focus-within:border-cyan-500',
    input: 'w-full h-10 px-3 border border-gray-400 overflow-hidden focus-within:border-cyan-500 rounded-lg text-base text-gray-700 placeholder-gray-400',
  },
